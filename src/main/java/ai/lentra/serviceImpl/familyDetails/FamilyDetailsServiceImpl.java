package ai.lentra.serviceImpl.familyDetails;
...
public class FamilyDetailsServiceImpl implements FamilyDetailsService {
    ...
    @Override
    public FamilyDetail insertFamilyDetails(FamilyDetailsRequest familyDetailsRequest) {
    ...
    @Override
    public Optional<FamilyDetail> getFamilyDetailsById(Integer familyDetailsId) {
        Optional<FamilyDetail> familyDetails = familyDetailsRepository.findById(familyDetailsId);
        return familyDetails;
    }

    @Override
    public List<FamilyDetail> findAll() {
        return familyDetailsRepository.findAll();
    }

    @Override
    public FamilyDetail familyDetailsUpdate(FamilyDetailsRequest familyDetailsRequest) {
        FamilyDetail familyDetails = new FamilyDetail();
       /* familyDetails.setFamilyDetailsId(familyDetailsRequest.getFamilyDetailsId());
        familyDetails.setNo_of_dependants(familyDetailsRequest.getNo_of_dependants());
        familyDetails.setNo_of_minor(familyDetailsRequest.getNo_of_minor());
