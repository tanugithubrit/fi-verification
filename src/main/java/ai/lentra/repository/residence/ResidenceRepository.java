package ai.lentra.repository.residence;
...
public interface ResidenceRepository extends JpaRepository<Residence, Long> {
    @Query(value = "SELECT r.id, r.residence_category, r.ownership_type,r.living_with,r.residence_type,r.no_of_storey," +
            ...
            "r.months_of_stay,r.distance_from_address_to_actual_loaction, r.negative_location,r.monthly_amortization,o.office_address_countryo" +
    ...
    Optional<Residence> findByAppId(Long residenceId);
}
